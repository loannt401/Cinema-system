<%-- 
    Document   : ctphim_datve
    Created on : May 2, 2023, 10:06:14 PM
    Author     : Admin
--%>
...
<html>
    ...
    <body>
        ...
        <div class="lichchieu">
            <form name="MyForm5" action="ctphimdatve" method="post" class="box">
                <input type="hidden" name="phim" value="${requestScope.phimId}"/>
